...
$config['mongo_db']['default']['hostname'] = 'ds039684.mongolab.com';
$config['mongo_db']['default']['port'] = '39684';
$config['mongo_db']['default']['username'] = 'kpatena';
$config['mongo_db']['default']['password'] = 'kyle081186';
$config['mongo_db']['default']['database'] = 'junkonus';
